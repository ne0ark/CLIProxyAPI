...
type RoutingConfig struct {
	...
	// Codex downstream websocket sessions when session affinity is enabled. A bound
	// Codex websocket session returns the bound auth's unavailability error instead
	// of switching to another auth and continuing with the old previous_response_id.
...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	// Sanitize API key policies and default fallback behavior.
