...
// IMPORTANT: This is called before tool name remapping, so it accepts both pre-remap
// and post-remap names and always returns the TitleCase variant for prompt text.
